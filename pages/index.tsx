...
import { ChevronDown, ChevronUp, MapPin, Calendar, Clock, Mail, MessageCircle, ExternalLink } from 'lucide-react';
          ...
          <div className="p-6 sm:p-8">
            <div className="space-y-6 border-b border-gray-200 pb-8">
              <div className="flex items-center space-x-3 text-gray-600">
                ...
                <a href={mapLink} className="text-teal-600 hover:text-teal-700 inline-flex items-center">
